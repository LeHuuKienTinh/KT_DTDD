...
<script>
import Top from '../components/TopAD.vue'
import Menu from '../components/MenuAD.vue'
import Footer from '../components/FooterAD.vue'
export default {
    name: 'app',
    components: {
        Top, Menu, Footer
...
/* @import url("https://cdn.jsdelivr.net/npm/moment@2.29.1/moment.min.js"); */
