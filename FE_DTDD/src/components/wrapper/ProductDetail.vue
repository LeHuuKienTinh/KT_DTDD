...
import axios from 'axios';
  ...
  methods: {
    ...
    addToCart() {
      console.log(`Thêm ${this.quantity} sản phẩm vào giỏ hàng.`);
    }
  }
};
  </script>
...
.input-number-container input[type="number"] {
  -webkit-appearance: inner-spin-button !important; /* Hiển thị spinner cho Chrome, Safari */
  appearance: inner-spin-button !important; /* Hiển thị spinner cho Firefox */
  -moz-appearance: textfield !important; /* Đảm bảo không ảnh hưởng đến Firefox */
}
...
.input-number-container input[type="number"] {
  -moz-appearance: textfield !important; /* Loại bỏ các spinner trong Firefox */
}
  </style>
